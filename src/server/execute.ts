/**
 * Cerebras Inference adapter — execute single agent run.
 *
 * v0.0.1: STUB.
 *
 * Strategy: streaming OpenAI-format HTTP client targeting
 *   https://api.cerebras.ai/v1/chat/completions
 * with Bearer \$CEREBRAS_API_KEY.
 *
...
export async function execute(): Promise<never> {
  throw new Error("cerebras-paperclip-adapter v0.0.1 is a scaffold; execute() not yet implemented");
}
